...
const CryptoDetails = () => {
    ...
    { id:3, title: '24h Volume', value: `$ ${ millify(cryptoDetails?.['24hVolume'])}`, icon: <ThunderboltOutlined /> },
    ...
    { id:8, title: 'Approved Supply', value: cryptoDetails?.supply?.confirmed ? <CheckOutlined /> : <StopOutlined />, icon: <ExclamationCircleOutlined /> },
